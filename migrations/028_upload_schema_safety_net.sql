-- Mirror of backend/database/migrations/028_upload_schema_safety_net.sql
-- For manual psql runs from repo root. Prefer: cd backend && python -m scripts.apply_migrations
